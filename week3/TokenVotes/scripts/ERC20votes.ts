...
async function main() {
  ...
  const contractAddress = await contract.target; //target (getAddress) can also get an ENS name if there is any in case of connecting to public blockchain network
